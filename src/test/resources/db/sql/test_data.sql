...
INSERT INTO student (person_first_name, person_last_name, group_id, person_email, person_phone) VALUES ('Kirill','Rumakin', 3, 'rumki@ya.ru', '+7(925)5554433'),('Katya','Jopushka', 1, 'jopka@jopka.com', '+7(925)1112233'),('Alexey', 'Nagosha', 2, 'naga@ya.ru', '+7(925)1234567');
...
INSERT INTO lesson (course_id, lesson_type_id, auditorium_id, date, time_slot_id) VALUES (1,1,1,'16-11-2020',2);
INSERT INTO lesson_teacher (lesson_id, person_id) VALUES (1,1);
INSERT INTO lesson_group (lesson_id, group_id) VALUES (1,1);
INSERT INTO lesson_teacher (lesson_id, person_id) VALUES (2,1);
...
INSERT INTO lesson_teacher (lesson_id, person_id) VALUES (3,3);
INSERT INTO lesson_teacher (lesson_id, person_id) VALUES (3,2);
INSERT INTO lesson_group (lesson_id, group_id) VALUES (3,3);
INSERT INTO security_users(first_name,last_name,email,password,role,status) VALUES ('User','Userov','user@user.com','$2y$12$DEq3wQPG30qH06rxqsz0ke9.vdxMUrARkAyxd.8PM78DDVkq3/x/6','USER','ACTIVE');
