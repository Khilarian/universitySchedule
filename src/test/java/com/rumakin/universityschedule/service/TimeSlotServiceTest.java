...
class TimeSlotServiceTest {
    ...
    @Test
    void findByIdShouldExecuteOnceWhenDbCallFineAndReturnTimeSlot() {
    ...
    @Test
    void findByNumberShouldExecuteOnceWhenDbCallFineAndReturnTimeSlot() {
    ...
    @Test
    void findByNumberShouldRaiseExceptionIfIdMissed() {
