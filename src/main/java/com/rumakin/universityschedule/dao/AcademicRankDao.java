...
import com.rumakin.universityschedule.dao.rowmapper.AcademicRankRowMapper;
import com.rumakin.universityschedule.models.AcademicRank;

public class AcademicRankDao {
   ...
   // private static final String FIND_ALL_ACADEMIC_RANK = "SELECT * FROM " + TABLE_NAME + ";";
    ...
    public AcademicRank findByName(String name) {
        return this.jdbcTemplate.queryForObject(FIND_BY_NAME, new Object[] { name }, new AcademicRankRowMapper());
    }

    @Override
    public List<AcademicRank> findAll() {
        return this.jdbcTemplate.query(FIND_ALL_ACADEMIC_RANK, new AcademicRankRowMapper());
    }
*/
}
